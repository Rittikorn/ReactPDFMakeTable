...
import { encodedSarabun } from "./assets/fonts/SarabunBASE64";
...
function App() {
  ...
  const printPDF = () => {
    ...
    pdfFonts.pdfMake.vfs["SarabunRegular_b64"] = encodedSarabun;
    ...
    pdfMake.fonts = {
      Sarabun: {
        normal: "SarabunRegular_b64",
        bold: "SarabunRegular_b64",
        italics: "SarabunRegular_b64",
        bolditalics: "SarabunRegular_b64",
      },
    };
    ...
    let docDefinition = {
      content: [
        { text: "ตารางสรุปรายการพนักงานสาขา บางรัก", style: "header" },
        {
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>
          Create <code>Thai PDF</code> and save to your PC.
        </p>
